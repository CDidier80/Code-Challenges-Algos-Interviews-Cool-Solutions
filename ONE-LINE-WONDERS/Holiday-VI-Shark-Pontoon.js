...
// sharkDistance = distance from the shark to the pontoon. The shark will eat you if it reaches 
// you before you escape to the pontoon.
...
shark=(p, sd, ys, ss, d)=>sd/(d?ss/2:ss)>p/ys?"Alive!":"Shark Bait!"





// one liner derived from this logic: 

function sharkLogic(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) {

  const sharkVelocity = dolphin ? sharkSpeed / 2 : sharkSpeed
  const humanTime = pontoonDistance / youSpeed
  const sharkTime = sharkDistance / sharkVelocity 

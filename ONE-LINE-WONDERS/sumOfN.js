// A sequence or a series, in mathematics, is a string of objects, like numbers, that 
// follow a particular pattern. The individual elements in a sequence are called terms. 
// A simple example is 3, 6, 9, 12, 15, 18, 21, ..., where the pattern is: 
...
const sumOfN = (n) => (new Array(Math.abs(n)+1)).fill(null).reduce((acc, val, i) => [...acc, (i === 0 ? 0 : (i * n / Math.abs(n) + acc[i-1]))], [])

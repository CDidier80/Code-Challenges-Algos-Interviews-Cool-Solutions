...
likes = (names) => names.length <= 3 ? 
    ...
    // obnoxious one liner
    // likes = (names) => names.length <= 3 ? [`no one likes this`, `${names[0]} likes this`, `${names[0]} and ${names[1]} like this`, `${names[0]}, ${names[1]} and ${names[2]} like this`][names.length] : `${names[0]}, ${names[1]} and ${names.length-2} others like this`


    // one liner derived from switch statement logic: 

    function likesInSwitchForm(names) {
        let sentence
        switch (names.length) {
          case 0:
